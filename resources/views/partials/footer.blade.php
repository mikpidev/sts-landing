         ...
         <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-sm-4">
               ...
               <div class="footer-contact">
                  ...
                  <ul>
                     <li>
                        <i class="lni lni-map-marker"></i> San Salvador,
                        El Salvador
                     </li>
                     <li><i class="lni lni-phone-set"></i> +503 7206-6635</li>
                     <li><i class="lni lni-envelope"></i> softwarentelco@sts.com</li>
                  </ul>
               </div>
               <!-- End Footer Contact -->
            </div>
         ...
         <div class="row">
            <div class="col-lg-12">
               <div
                  ...
                  align-items-center
                  ">
                  <p class="text">Copyright © 2026 Software and Telco Solutions. All Rights Reserved</p>
                  <ul class="social">
                     <li>
                        <a href="javascript:void(0)">
