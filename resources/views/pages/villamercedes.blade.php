      ...
      <div class="row align-items-center mb-5">
         ...
         <div class="col-lg-8">
            ...
            <p class="lead text-muted">
               Developed a full-stack web application for a local coffee shop following
               El Salvador's new electronic invoicing regulations. The platform
               streamlines point-of-sale operations, integrates Electronic Tax
               Documents (DTE) with the Ministry of Finance, and provides customer
               management, reporting, and role-based access control.
            </p>
         ...
         <div class="col-lg-4 text-center">
            ...
            <img src="https://i.ibb.co/gZV0VkMx/Villa-Mercedes.png"
               class="img-fluid"
   ...
   <div class="container-fluid px-lg-5 px-3"> <!-- row -->
      <div class="row grid">
         <div class="col-lg-4 col-sm-6 show" data-filter="features">
            <div class="portfolio-style-one text-center">
               <div class="portfolio-image">
                  <img src="https://i.ibb.co/zhPyHhSp/salesview.png" alt="salesview" border="0"></a>
               </div>
                  ...
                  <div class="portfolio-content">
                     <div class="portfolio-icon">
                        <a
                           ...
                           href="https://i.ibb.co/zhPyHhSp/salesview.png">
         ...
         <div class="col-lg-4 col-sm-6 show" data-filter="features">
            <div class="portfolio-style-one text-center">
               <div class="portfolio-image">
                  <img src="https://i.ibb.co/235Sf8gZ/invoice.png" alt="invoice"></a>
               </div>
               <div class="portfolio-overlay d-flex align-items-center">
                  <div class="portfolio-content">
                     <div class="portfolio-icon">
                        <a
                           class="image-popup-two glightbox"
                           href="https://i.ibb.co/235Sf8gZ/invoice.png">
                           <i class="lni lni-zoom-in"></i>
                        </a>
                     </div>
                     <div class="portfolio-text">
                        <h4 class="portfolio-title">
                           <a href="javascript:void(0)">Electronic Invoicing (DTE)</a>
                        </h4>
                        <p class="text">
         ...
         <div class="col-lg-4 col-sm-6 show" data-filter="features">
            <div class="portfolio-style-one text-center">
               <div class="portfolio-image">
                  <img
                     src="https://i.ibb.co/DH3Vz1N5/reportsview.png"
                     alt="image" />
               </div>
               <div class="portfolio-overlay d-flex align-items-center">
                  <div class="portfolio-content">
                     <div class="portfolio-icon">
                        <a
                           class="image-popup-two glightbox"
                           href="https://i.ibb.co/DH3Vz1N5/reportsview.png">
                           <i class="lni lni-zoom-in"></i>
                        </a>
                     </div>
                     <div class="portfolio-text">
                        <h4 class="portfolio-title">
                           <a href="javascript:void(0)">Compliance Reports</a>
                        </h4>
                        <p class="text">
         ...
         <div class="col-lg-4 col-sm-6 show" data-filter="features">
            <div class="portfolio-style-one text-center">
               <div class="portfolio-image">
                  <img
                     src="https://i.ibb.co/sdVy7pgB/customers.png"
                     alt="image" />
               </div>
               <div class="portfolio-overlay d-flex align-items-center">
                  <div class="portfolio-content">
                     <div class="portfolio-icon">
                        <a
                           class="image-popup-two glightbox"
                           href="https://i.ibb.co/sdVy7pgB/customers.png">
                           <i class="lni lni-zoom-in"></i>
                        </a>
                     </div>
                     <div class="portfolio-text">
         ...
         <div class="col-lg-4 col-sm-6 show" data-filter="features">
            <div class="portfolio-style-one text-center">
               <div class="portfolio-image">
                  <img
                     src="https://i.ibb.co/SwtsrQnX/users.png"
                     alt="image" />
               </div>
               <div class="portfolio-overlay d-flex align-items-center">
                  <div class="portfolio-content">
                     <div class="portfolio-icon">
                        <a
                           class="image-popup-two glightbox"
                           href="https://i.ibb.co/SwtsrQnX/users.png">
                           <i class="lni lni-zoom-in"></i>
                        </a>
                     </div>
                     <div class="portfolio-text">
